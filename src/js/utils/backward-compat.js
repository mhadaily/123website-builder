...
silex.utils.BackwardCompat.process = function(doc, model, cbk) {
  ...
  if (silex.utils.BackwardCompat.amIObsolete(version, silex.utils.BackwardCompat.LATEST_VERSION)) {
    silex.utils.Notification.alert('This website has been saved with a newer version of 123Website. Continue at your own risks.', function() {});
  }
  else if (hasToUpdate) {
    silex.utils.Notification.alert('This website has been updated with the latest version of 123websi.<br><br>Before you save it, please check that everything is fine. Saving it with another name could be a good idea too (menu file > save as).', function() {});
  }

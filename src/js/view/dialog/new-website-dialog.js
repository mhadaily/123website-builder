  ...
  if(Array.isArray(data)) {
    ...
    data
      ...
      .map(item => {
        ...
        thumbnail.style.backgroundImage = `url(https://www.majidhajian.com/${repo}/${item.name}/screenshot.png)`;
        thumbnail.setAttribute('data-editable', `https://www.majidhajian.com/${repo}/${item.name}/editable.html`);
        ...
        h3.innerHTML = name;
        h3.setAttribute('data-editable', `https://www.majidhajian.com/${repo}/${item.name}/editable.html`);
        ui.appendChild(h3);
        ...
        previewEl.href = `https://www.majidhajian.com/${repo}/${item.name}/index.html`;
        ...
        infoEl.href = `https://github.com/mhadaily/${repo}/blob/gh-pages/${item.name}/README.md`;
        ...
        editEl.setAttribute('data-editable', `https://www.majidhajian.com/${repo}/${item.name}/editable.html`);
...
silex.view.dialog.NewWebsiteDialog.prototype.buildUi = function() {
  const createList = (ul, repo, success, error) => {
    const repoUrl = `https://api.github.com/repos/mhadaily/${repo}/contents`;
  ...
  const toLoad = [
    {
      ...
      repo: '123website-templates',
    },
    {
      selector: '.blank-page-pane ul',
      repo: '123website-blank-templates',
    },
  ];
  loadNext(toLoad);
  // clear button
